        ...
        <el-row>
          ...
          <el-col :span="24">
            ...
            <div class="postInfo-container">
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="60px" label="作者名:" class="postInfo-container-item">
                    <el-select v-model="postForm.author" :remote-method="getRemoteUserList" filterable
                               default-first-option remote placeholder="选择用户">
...
import {fetchArticle} from '@/api/community/article'
import {searchUser} from '@/api/community/remote-search'
